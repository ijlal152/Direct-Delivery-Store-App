import 'package:delivery_app/suplierPages/AddSuplier.dart';
import 'package:flutter/material.dart';
import 'package:getwidget/getwidget.dart';

class SuplierPage extends StatefulWidget {
  const SuplierPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
          ...
          appBar: AppBar(
            backgroundColor: Colors.transparent,
            title: const Text('Supplier', style: TextStyle(color: Colors.white, fontFamily: 'Gilroy-Regular'),),
            centerTitle: true,
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (_)=> AddSuplier()));
            },
