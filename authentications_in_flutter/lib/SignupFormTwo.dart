...
import 'package:authentications_in_flutter/DbHelper.dart';
import 'package:authentications_in_flutter/LoginForm.dart';
import 'package:authentications_in_flutter/UserModel.dart';
import 'package:authentications_in_flutter/comHelper.dart';
...
class _SignupFormTwoState extends State<SignupFormTwo> {
  ...
  //final TextEditingController _fullphoneno = TextEditingController();
  ...
  String? currency;
  void getCurrency(){
    currency = NumberFormat.simpleCurrency(locale: Platform.localeName) as String?;
    print('Currency is: $currency.currencySymbol');
  }
  ...
  registerAccount() async{
    ...
    if(formkey.currentState!.validate()){
      ...
      UserModel uModel = UserModel(widget.email.toString(), widget.password.toString(), _fullname.text, _shopname.text, countrycode.toString(), _phoneno.text, finalnumber.toString(), currency.toString(), _address.text);
